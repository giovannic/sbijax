...
python examples/seir.py -m n_simulations=1000,5000,10000 n_sites=50 n_obs=5 n_rounds=1 n_epochs=1000 seed=0,1,2,3,4 f_in_sample=prior
python examples/seir.py -m n_simulations=5000 n_rounds=1 n_epochs=1000 n_obs=5 n_sites=1,2,5,10,20,50 seed=0,1,2,3,4 f_in_sample=prior
